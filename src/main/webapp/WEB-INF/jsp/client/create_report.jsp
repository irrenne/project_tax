...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <form action="<c:url value="/client/file"/>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control" name="type" id="type">
                            ...
                            <c:forEach items="${types}" var="value">
                                <c:choose>
                                    <c:when test="${lang == 'en'}">
                                        <option value="${value}">${fn:toLowerCase(value)}</option>
                                    </c:when>
                                    <c:otherwise>
                                        <option value="${value}">${value.localization}</option>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                        </select>
                ...
                <div class="d-flex flex-row justify-content-end mt-auto">
                    <button type="submit" class="btn blue-gradient btn-md" id="button1" value="submit" disabled>
                        <fmt:message
                                key="label.createReportButton"/></button>
                </div>
